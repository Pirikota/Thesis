/*************************************************** 
 Ne kete kod paraqitet ndertimi i nje makinerie votimi nepermjet platformes arduino.
 Si kandidat kane sherbyer tre fakultete te UPT.
 Procesi i enrolling te shenjave te gishtit duhet te behet paraprakisht.
 ****************************************************/
